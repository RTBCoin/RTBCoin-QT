...
; Settings 
Name "RTBCoin (RTB-Qt)"
OutFile "rtb-qt-install.exe"
RequestExecutionLevel admin
InstallDir "$PROGRAMFILES64\RTBCoin"
Icon "rtb.ico"
CRCCheck on
...
Section "Install RTB-Qt (GUI)" Section1
  SetOutPath $INSTDIR
  File "content\rtb-qt-win.exe"
  CreateShortCut "$DESKTOP\RTB-Qt.lnk" "$INSTDIR\rtb-qt-win.exe"
SectionEnd
...
Section "Create rtb.conf" Section2
  SetOverwrite on
  CreateDirectory "$APPDATA\RTB"  
  SetOutPath $APPDATA\RTB
  File "content\rtb.conf"
SectionEnd
