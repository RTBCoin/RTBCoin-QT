/******************************************************************************
 * Copyright © 2021 RTB Core Developers                                    *
 *                                                                            *
...
#define RTB_ELECTION_GAP 2000    //((ASSETCHAINS_SYMBOL[0] == 0) ? 2000 : 100)
...
extern uint256 RTB_EARLYTXID;
extern bool IS_RTB_NOTARY;

extern bool IS_MODE_EXCHANGEWALLET;
extern bool IS_RTB_DEALERNODE;

extern int32_t RTB_MININGTHREADS;
extern int32_t STAKED_NOTARY_ID;
extern int32_t USE_EXTERNAL_PUBKEY;
extern int32_t RTB_REWIND;
extern int32_t STAKED_ERA;
extern int32_t RTB_CONNECTING;
extern int32_t RTB_EXTRASATOSHI;
extern int32_t ASSETCHAINS_FOUNDERS;
extern int32_t RTB_NSPV;
extern int32_t RTB_INSYNC;
extern int32_t RTB_LASTMINED;
extern int32_t prevRTB_LASTMINED;
extern int32_t RTB_CCACTIVATE;
...
extern uint32_t RTB_STOPAT; // set by -stopat, will not add more blocks after specified height
extern uint32_t RTB_DPOWCONFS; // set by -dpowconfs, normally 0/1
...
extern uint64_t RTB_INTERESTSUM; // calculated value, returned in getinfo() RPC call
extern uint64_t RTB_WALLETBALANCE; // pwalletmain->GetBalance(), returned in getinfo() RPC call
...
extern std::mutex rtb_mutex; // seems to protect PAX values and Pubkey array
//extern std::vector<uint8_t> Mineropret; // previous miner values
extern pthread_mutex_t RTB_CC_mutex; // mutex to help with CryptoConditions
extern CScript RTB_EARLYTXID_SCRIPTPUB; // used mainly in cc/prices.cpp
