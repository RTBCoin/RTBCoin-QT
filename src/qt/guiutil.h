...
#ifndef RTB_QT_GUIUTIL_H
#define RTB_QT_GUIUTIL_H
...
/** Utility functions used by the RTB Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "rtb:" URI into recipient object, return true on successful parsing
