...
WalletFrame::WalletFrame(const PlatformStyle *_platformStyle, RTBCoinGUI *_gui) :
    QFrame(_gui),
    gui(_gui),
...
bool WalletFrame::addWallet(const QString& name, WalletModel *walletModel)
{
    ...
    connect(gui, &RTBCoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
