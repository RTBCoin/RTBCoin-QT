    ...
    mapper(0)
{
    ...
    ui->rtbAtStartup->setToolTip(ui->rtbAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->rtbAtStartup->setText(ui->rtbAtStartup->text().arg(tr(PACKAGE_NAME)));
...
{
    /* Main */
    mapper->addMapping(ui->rtbAtStartup, OptionsModel::StartAtStartup);
