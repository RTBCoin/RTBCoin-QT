...
#ifndef RTB_QT_RTBUNITS_H
#define RTB_QT_RTBUNITS_H
...
/** RTB unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    /** RTB units.
      @note Source: https://en.rtb.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KMD,
