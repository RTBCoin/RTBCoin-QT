/*
 ...
 Just update the functions in this file, then from ~/rtb/src/cc
 
 ../rtb-cli -ac_name=CUSTOM stop
 ./makecustom
 ../rtbd -ac_name=CUSTOM -ac_cclib=custom -ac_cc=2 ...
 
 The above will rebuild rtbd and get it running again
 */
...
{
    CMutableTransaction mtx = CreateNewContextualCMutableTransaction(Params().GetConsensus(), rtb_nextheight()); std::string rawtx;
