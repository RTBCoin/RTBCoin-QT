...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("RTB RPC client version") + " " + FormatFullVersion() + "\n" + PrivacyInfo();
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  rtb-cli [options] <command> [params]  " + _("Send command to RTB") + "\n" +
                  "  rtb-cli [options] help                " + _("List commands") + "\n" +
                  "  rtb-cli [options] help <command>      " + _("Get help for a command") + "\n";
