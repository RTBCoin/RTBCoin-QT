...
public:
    CMainParams()
    {
        ...
        genesis.nBits    = RTB_MINDIFF_NBITS;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("rtbseeds.org", "kmd.rtbseeds.org")); // decker
        ...
        /*
        vSeeds.push_back(CDNSSeedData("rtbseeds.com", "kmd.rtbseeds.com"));
        vSeeds.push_back(CDNSSeedData("rtbseeds.com", "dynamic.rtbseeds.com"));
        */
...
void rtb_setactivation(int32_t height)
{
