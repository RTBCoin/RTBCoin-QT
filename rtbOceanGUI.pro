...
# Input
DEPENDPATH += .
HEADERS += src\rtb_globals.h \
     src\qt\rtboceangui.h \
...
SOURCES += src\protobuf\google\protobuf\any.cc \
    ...
    src\qt\intro.cpp \
    src\qt\rtb.cpp \
    src\qt\rtbaddressvalidator.cpp \
    src\qt\rtbamountfield.cpp \
    src\qt\rtboceangui.cpp \
    src\qt\rtbunits.cpp \
...
# also add new translations to rtb.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/rtb_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md src/qt/res/rtb-qt-res.rc
...
windows:RC_FILE = src/qt/res/rtb-qt-res.rc
...
macx:ICON = src/qt/res/icons/rtb.icns
macx:TARGET = "RTBCoinGUI"
