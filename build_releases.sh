...
copy_release() {
    ...
    case $release_name in
        xenial)
            ...
            mv "${WORKSPACE}/releases/${release_name}/rtb-qt" "${WORKSPACE}/releases/${release_name}/rtb-qt-linux"
            ;;
        focal)
        ...
        windows)
            ...
            mv "${WORKSPACE}/releases/${release_name}/rtb-qt${ext}" "${WORKSPACE}/releases/${release_name}/rtb-qt-windows${ext}"
            ;;
        macos)
            ...
            mv "${WORKSPACE}/releases/${release_name}/rtb-qt${ext}" "${WORKSPACE}/releases/${release_name}/rtb-qt-mac${ext}"
            ;;
        *)
